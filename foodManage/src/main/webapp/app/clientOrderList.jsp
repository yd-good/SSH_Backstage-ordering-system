...
<body style="text-align: center">
	<div id="all">
		...
		<div id="dish_class">
			...
			<div id="dish_3">
				<!-- 搜索菜品表单  -->
				<form action="${pageContext.request.contextPath}/app/wirelessplatform/food.jsp" method="post">
					<table width="166px">
						<tr>
							<td>
						...
						<tr>
							<td>
								<a href="${pageContext.request.contextPath}/app/wirelessplatform/food.jsp?method=selectFood">
