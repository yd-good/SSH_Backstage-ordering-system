                ...
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="${seeCar.carName}" disabled>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker-a3" placeholder="${seeCar.date}" disabled>
                            </div>
                        </div>
                        <div class="col-md-2 title">汽车库存数量</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="${seeCar.number}" disabled>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" disabled placeholder="${seeCar.price}">
                        </div>
                    </div>
                </div>
                <!--订单信息/-->
