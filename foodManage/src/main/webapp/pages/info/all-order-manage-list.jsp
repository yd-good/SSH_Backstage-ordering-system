                        ...
                        <span class="hidden-xs"></span>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ${sessionScope.admin.name} - 数据管理员
                                        <small>最后登录 <%= new Date()%></small>
                                    </p>
                                </li>
                                <!-- Menu Body 
                        <li class="user-body">
                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="新建" onclick='location.href="all-order-manage-edit.jsp"'><i class="fa fa-file-o"></i> 新建</button>
                            ...
                            <div class="box-tools pull-right">
                                <div class="has-feedback">
                                    ...
                                    <form action="car_search">
                                        <input type="text" class="form-control input-sm" placeholder="搜索" href="car_search" name="carName"><input type="submit" value="查询">
                                    </form>
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sorting">汽车编号</th>
                                        <th class="sorting">汽车名称</th>
                                        <th class="sorting">汽车价格</th>
                                        <th class="sorting">出产年份</th>
                                        <th class="sorting">存储数量</th>
                              ...
                              <c:choose>
                                <c:when test="${not empty requestScope.cars}">
                                   <c:forEach items="${requestScope.cars}" var="car" varStatus="vs">
                                       <tr>
                                           ...
                                           <td class="text-center">
                                               <button type="button" class="btn bg-olive btn-xs" onclick='location.href="car_delete?id=${car.id}"'>删除</button>
                                               <button type="button" class="btn bg-olive btn-xs" onclick='location.href="car_seeCar?id=${car.id}"'>详情</button>
                                               <button type="button" class="btn bg-olive btn-xs" onclick='location.href="car_InUpdate?id=${car.id}"'>编辑</button>
                                           </td>
                                       </tr>
                                   </c:forEach>
                                </c:when>
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="新建" onclick='location.href="all-order-manage-edit.jsp"'><i class="fa fa-file-o"></i> 新建</button>
                                        <button type="button" class="btn btn-default" title="删除" onclick='deletAll()' ><i class="fa fa-trash-o"></i> 删除</button>
                                        <button type="button" class="btn btn-default" title="开启" onclick='confirm("你确认要开启吗？")'><i class="fa fa-check"></i> 开启</button>
                                        <button type="button" class="btn btn-default" title="屏蔽" onclick='confirm("你确认要屏蔽吗？")'><i class="fa fa-ban"></i> 屏蔽</button>
                                        <button type="button" class="btn btn-default" title="刷新" onclick="window.location.reload();"><i class="fa fa-refresh"></i> 刷新</button>
                                    </div>
