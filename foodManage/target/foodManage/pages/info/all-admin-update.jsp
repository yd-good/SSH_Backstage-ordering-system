        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="all-order-manage-list.html">车辆管理</a></li>
                    <li class="active">车辆表单</li>
                </ol>
            </section>
            <!-- 内容头部 /-->
            ...
            <section class="content">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">车辆详细信息</div>
                    <div class="row data-type">

                        <div class="col-md-2 title">汽车名称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" value="${upCar.carName}" name="carName">
                        </div>

                        <div class="col-md-2 title">出厂时间</div>
                        <div class="col-md-4 data">
                            <div class="input-group date">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar"></i>
                                </div>
                                <input type="text" class="form-control pull-right" id="datepicker-a3" value="${upCar.date}" name="date">
                            </div>
                        </div>
                        <div class="col-md-2 title">汽车库存数量</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" value="${upCar.number}" name="number">
                        </div>




                        <div class="col-md-2 title">汽车价格</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control"  value="${upCar.price}" name="price">
                        </div>
                    </div>
                </div>
                <!--订单信息/-->
                ...
                <div class="box-tools text-center">
                    <input type="submit" value="保存" class="btn bg-maroon">
