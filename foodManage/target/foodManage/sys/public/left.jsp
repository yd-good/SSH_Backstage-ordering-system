	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="table_list.action">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/foodType_list.action">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/dishes_allFoodList.action">菜品管理</a>
				</li>
				<s:if test="%{#session.admin_role.role_Name == '最高管理者'}">
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath}/user_userList.action">员工管理</a>
				</li>
				</s:if>
            </ul>
        </li>
